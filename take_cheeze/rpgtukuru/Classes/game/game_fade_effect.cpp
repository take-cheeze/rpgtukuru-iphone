...
void GameFadeEffect::render(kuto::Graphics2D& g)
{
	switch (state_) {
	case kStateEncountFlash:
		renderBattleFlash(g);
...
void GameFadeEffect::renderBattleFlash(kuto::Graphics2D& g)
{
...
void GameFadeEffect::renderFade(kuto::Graphics2D& g, float ratio)
{
	kuto::Color color(0.f, 0.f, 0.f, ratio);
	g.fillRectangle(kuto::Vector2(0, 0), kuto::Vector2(320, 240), color);
}

void GameFadeEffect::renderRandomBlock(kuto::Graphics2D& g, float ratio)
{
...
void GameFadeEffect::renderBlind(kuto::Graphics2D& g, float ratio)
{
	kuto::Color color(0.f, 0.f, 0.f, 1.f);
	for (int i = 0; i < 30; i++) {
...
void GameFadeEffect::renderStripeVertical(kuto::Graphics2D& g, float ratio)
{
...
void GameFadeEffect::renderStripeHorizontal(kuto::Graphics2D& g, float ratio)
{
	const kuto::Color color(0.f, 0.f, 0.f, 1.f);
...
void GameFadeEffect::renderHoleShrink(kuto::Graphics2D& g, float ratio)
{
	kuto::Color color(0.f, 0.f, 0.f, 1.f);
...
void GameFadeEffect::renderHoleExpand(kuto::Graphics2D& g, float ratio)
{
	kuto::Color color(0.f, 0.f, 0.f, 1.f);
